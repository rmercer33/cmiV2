...
test("Integration Test - Parse and Insert to Local DynamoDB", async () => {
  ...
  console.log(output2);
  assert.match(output2, /Found 5 existing records. Deleting.../);
